...
export const PREP_TEMPLATES: { label: string; items: Omit<PrepItem, "id">[] }[] = [
  ...
  },
  {
    label: "出境游",
    items: [
      { name: "护照", category: "证件", done: false },
      { name: "签证", category: "证件", done: false },
      { name: "身份证", category: "证件", done: false },
      { name: "手机", category: "电子", done: false },
      { name: "国际转换插头", category: "电子", done: false },
      { name: "充电宝", category: "电子", done: false },
      { name: "外币 / 信用卡", category: "其他", done: false },
      { name: "翻译 APP", category: "其他", done: false },
      { name: "肠胃药", category: "药品", done: false },
    ],
  },
  {
    label: "亲子游",
    items: [
      { name: "身份证 / 儿童身份证", category: "证件", done: false },
      { name: "手机", category: "电子", done: false },
      { name: "充电宝", category: "电子", done: false },
      { name: "儿童换洗衣物", category: "衣物", done: false },
      { name: "婴儿车 / 推车", category: "其他", done: false },
      { name: "奶粉 / 辅食", category: "其他", done: false },
      { name: "退烧药", category: "药品", done: false },
      { name: "湿纸巾", category: "其他", done: false },
    ],
  },
];
